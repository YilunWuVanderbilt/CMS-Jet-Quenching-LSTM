...
parser.add_argument('-s',help='enable pedestal cut', required=False, default=False, action='store_true')
...
print('Enable pedestal cut:\t%r' % args.s)
print('*********************************')
...
def set_branches(tr):
    ...
    tr.Branch('jetfpt', jetfpt, 'jetfpt/F')
